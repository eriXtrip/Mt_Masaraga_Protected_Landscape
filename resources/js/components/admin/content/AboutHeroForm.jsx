...
export default function AboutHeroForm({ hero, onSave, onClose }) {
            ...
            >
                <div className="flex items-start justify-between gap-4 border-b border-outline-variant/20 px-5 py-4">
                    <div>
                        ...
                        <h2 className="mt-1 text-lg font-bold text-on-surface">Edit About Section</h2>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
                    <div>
                        ...
                        <Input value={form.title} onChange={setField('title')} required placeholder="e.g. Discover Mt. Masaraga" />
                    </div>
                    <div>
                        <label className="block text-xs font-semibold text-on-surface-variant uppercase tracking-wide mb-1.5">Subtitle</label>
                        <textarea
                            value={form.subtitle}
                ...
                <div className="border-t border-outline-variant/20 px-5 py-4 flex items-center justify-end gap-3">
                    ...
                    <Button type="submit" onClick={handleSubmit} className="gap-2 cursor-pointer">Save changes</Button>
                </div>
            </aside>
        </div>
    );
