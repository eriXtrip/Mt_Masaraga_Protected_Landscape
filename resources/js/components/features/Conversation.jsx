...
export default function Conversation({
    ...
    return (
        <div className="flex flex-col h-[70vh] min-h-125 md:h-150 bg-surface-container-lowest border border-outline-variant/40 rounded-3xl shadow-xl overflow-hidden">
